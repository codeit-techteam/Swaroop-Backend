...
@Controller({ path: 'customer/support/tickets', version: '1' })
...
export class CustomerSupportController {
  ...
  async create(
    ...
    return successResponse(
      await this.support.create(user.id, SupportRequesterType.CUSTOMER, dto),
  ...
  async get(
    ...
    return successResponse(
      await this.support.getMine(user.id, SupportRequesterType.CUSTOMER, id),
